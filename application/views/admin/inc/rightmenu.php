					...
					<div class="tab-pane active" id="tab">
						<div class="card-body p-0">
							<div class="header-user text-center mt-4">
								<span class="avatar avatar-xxl brround mx-auto"><img src="../admin_assets/img/faces/5.jpg" alt="Profile-img" class="avatar avatar-xxl brround"></span>
							...
							<div class="card-body border-top">
								...
								<div class="row mt-4">
									<div class="col-12">
										<div class="followers">
											<a href="#" class="avatar brround avatar-md cover-image m-1" data-image-src="../admin_assets/img/faces/3.jpg">
												<span class="avatar-status bg-green"></span>
											</a>
											<a href="#" class="avatar brround avatar-md cover-image m-1" data-image-src="../admin_assets/img/faces/6.jpg">
												<span class="avatar-status bg-red"></span>
											</a>
											<a href="#" class="avatar brround avatar-md cover-image m-1" data-image-src="../admin_assets/img/faces/3.jpg">
												<span class="avatar-status bg-warning"></span>
											</a>
											<a href="#" class="avatar brround avatar-md cover-image m-1" data-image-src="../admin_assets/img/faces/4.jpg">
												<span class="avatar-status bg-green"></span>
											</a>
											<a href="#" class="avatar brround avatar-md cover-image m-1" data-image-src="../admin_assets/img/faces/9.jpg">
												<span class="avatar-status bg-warning"></span>
											</a>
								...
								<ul class="contacts mb-0">
									<li class="active">
										<div class="d-flex bd-highlight w-100">
											<div class="img_cont">
												<img src="../admin_assets/img/faces/12.jpg" class="rounded-circle user_img" alt="img">
									...
									<li>
										<div class="d-flex bd-highlight w-100">
											<div class="img_cont">
												<img src="../admin_assets/img/faces/2.jpg" class="rounded-circle user_img" alt="img">
												<span class=" online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li>
										<div class="d-flex bd-highlight w-100">
											<div class="img_cont">
												<img src="../admin_assets/img/faces/5.jpg" class="rounded-circle user_img" alt="img">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
												<h5 class="mt-1 mb-1">Maryam Naz</h5>
									...
									<li>
										<div class="d-flex bd-highlight w-100">
											<div class="img_cont">
												<img src="../admin_assets/img/faces/7.jpg" class="rounded-circle user_img" alt="img">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li>
										<div class="d-flex bd-highlight w-100">
											<div class="img_cont">
												<img src="../admin_assets/img/faces/8.jpg" class="rounded-circle user_img" alt="img">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li>
										<div class="d-flex bd-highlight w-100">
											<div class="img_cont">
												<img src="../admin_assets/img/faces/3.jpg" class="rounded-circle user_img" alt="img">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li>
										<div class="d-flex bd-highlight w-100">
											<div class="img_cont">
												<img src="../admin_assets/img/faces/14.jpg" class="rounded-circle user_img" alt="img">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li>
										<div class="d-flex bd-highlight w-100">
											<div class="img_cont">
												<img src="../admin_assets/img/faces/11.jpg" class="rounded-circle user_img" alt="img">
											</div>
											<div class="user_info">
												<h5 class="mt-1 mb-1">Khadija Mehr</h5>
